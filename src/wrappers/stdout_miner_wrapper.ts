...
export abstract class StdOutMinerWrapper extends Units.IMiner {
    protected miner: ChildProcess;
    protected coin: Units.ICoinConfig;
    ...
    public async launchMinerBinary(coin: Units.ICoinConfig,
                                   args: string[],
    ...
    protected async exec(executable: string, args: string[], stdoutParser: parserFn, stderrParser: parserFn) {
        this.miner = await spawn(executable, args,  {env: {GPU_MAX_ALLOC_PERCENT: 100, GPU_USE_SYNC_OBJECTS: 1}});
